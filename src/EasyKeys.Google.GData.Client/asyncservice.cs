...
namespace EasyKeys.Google.GData.Client
{
    ...
    public partial class Service : AsyncDataHandler, IService, IVersionAware
    {
        ...
        {
            QueryAsync(queryUri, ifModifiedSince, true, userData);
        }
        ...
        {
            QueryAsync(queryUri, ifModifiedSince, false, userData);
        }
        ...
        /// <param name="userData">a unique identifier to associate this request with</param>
        /// <returns></returns>
        public void StreamSendFeedAsync(
            Uri targetUri,
            Stream inputStream,
        ...
        /// <param name="userData">a unique identifier to associate this request with</param>
        /// <returns></returns>
        public void StreamSendStreamAsync(
            Uri targetUri,
            Stream inputStream,
            GDataRequestType type,
            string contentType,
            ...
            bool parseFeed)
        {
            AsyncSendData data = new AsyncSendData(this, targetUri, inputStream, type, contentType, slugHeader,
                ProgressReportDelegate, userData, parseFeed);
        ...
        /// <param name="completionMethodDelegate"></param>
        /// <returns></returns>
        private void AsyncUpdateWorker(
            AsyncSendData data,
            ...
            SendOrPostCallback completionMethodDelegate)
        {
            try
            {
                data.Entry = Update(data.Entry, data);
            }
            catch (Exception e)
            {
                data.Exception = e;
        ...
        /// <param name="completionMethodDelegate"></param>
        /// <returns></returns>
        private void AsyncInsertWorker(
            AsyncSendData data,
            AsyncOperation asyncOp,
            SendOrPostCallback completionMethodDelegate)
        {
            try
            {
                data.Entry = Insert(data.UriToUse, data.Entry, data);
            }
            catch (Exception e)
            {
                data.Exception = e;
            ...
            SendOrPostCallback completionMethodDelegate)
        {
            try
            {
                data.Feed = Batch(data.Feed, data.UriToUse, data);
            }
            catch (Exception e)
            {
                data.Exception = e;
