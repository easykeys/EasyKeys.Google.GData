...
namespace EasyKeys.Google.GData.Client
{
    ...
    public class AtomPerson : AtomBase
    {
        ...
        {
            get { return _type == AtomPersonType.Author ? AtomParserNameTable.XmlAuthorElement : AtomParserNameTable.XmlContributorElement; }
        }
        /////////////////////////////////////////////////////////////////////////////
        ...
        protected override void SaveInnerXml(XmlWriter writer)
        {
            ...
            // now save our state...
            WriteEncodedElementString(writer, BaseNameTable.XmlName, Name);
            WriteEncodedElementString(writer, AtomParserNameTable.XmlEmailElement, Email);
            WriteEncodedElementString(writer, AtomParserNameTable.XmlUriElement, Uri);
        }
        ...
        public override bool ShouldBePersisted()
        {
            ...
            {
                if (Utilities.IsPersistable(_name))
                {
                    return true;
                }
                ...
                if (Utilities.IsPersistable(_uri))
                {
                    return true;
                }
