...
namespace EasyKeys.Google.GData.Client
{
    ...
    public class FeedParserEventArgs : EventArgs
    {
        ...
        {
            get { return _feedEntry; }
            set { _feedEntry = value; }
        }
