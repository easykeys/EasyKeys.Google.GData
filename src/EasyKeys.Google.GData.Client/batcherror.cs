...
namespace EasyKeys.Google.GData.Extensions
{
    public class BatchError : SimpleContainer
    {
        ...
        public string Domain
        {
            get
            {
                return GetStringValue<BatchErrorDomain>(
            ...
            set
            {
                SetStringValue<BatchErrorDomain>(
                    value.ToString(),
                    BaseNameTable.gdDomain,
                    BaseNameTable.gNamespace);
            }
        ...
        public string Code
        {
            get
            {
                return GetStringValue<BatchErrorCode>(
        ...
        public string InternalReason
        {
            get
            {
                return GetStringValue<BatchErrorInternalReason>(
            ...
            set
            {
                SetStringValue<BatchErrorInternalReason>(
                    value.ToString(),
                    BaseNameTable.gdInternalReason,
                    BaseNameTable.gNamespace);
            }
        ...
        public string Id
        {
            get
            {
                return GetStringValue<BatchErrorId>(
