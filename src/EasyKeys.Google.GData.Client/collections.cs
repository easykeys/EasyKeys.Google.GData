...
namespace EasyKeys.Google.GData.Client
{
    ...
    public class AtomEntryCollection : AtomCollectionBase<AtomEntry>
    {
        ...
        public override AtomEntry this[int index]
        {
            ...
            set
            {
                if (value != null)
                {
                    if (value.Feed == null || value.Feed != _feed)
                    {
                        value.setFeed(_feed);
                    }
                }
    ...
    public class ExtensionList : IList<IExtensionElementFactory>
    {
        ...
        public int Add(IExtensionElementFactory value)
        {
            ...
            if (target != null)
            {
                target.ProtocolMajor = _container.ProtocolMajor;
                target.ProtocolMinor = _container.ProtocolMinor;
            }
