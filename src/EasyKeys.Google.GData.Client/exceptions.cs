...
namespace EasyKeys.Google.GData.Client
{
    ...
    public class GDataRequestException : LoggedException
    {
        ...
        protected string ReadResponseString()
        {
            ...
            {
                string headerVal = webResponse.Headers[i].ToLower();
                ...
                {
                    responseStream = new System.IO.Compression.DeflateStream(
                        responseStream,
                        System.IO.Compression.CompressionMode.Decompress);
                    break;
                }
    ...
    public class GDataRedirectException : GDataRequestException
    {
        ...
        public string Location
        {
            get
            {
                return _redirectLocation != null ? _redirectLocation : "";
            }
        }
    }
