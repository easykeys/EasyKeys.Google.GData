...
namespace EasyKeys.Google.GData.Extensions
{
    ...
    public class ExtensionCollection<T> : IList<T> where T : class, IExtensionElementFactory, new()
    {
        ...
        private IExtensionContainer _container;
            ...
            : base()
        {
            ...
            if (_container != null)
            {
                ExtensionList arr = _container.FindExtensions(localName, ns);
                foreach (T o in arr)
                {
                    _items.Add(o);
                }
        ...
        protected void setItem(int index, T item)
        {
            if (_items[index] != null)
            {
                if (_container != null)
                {
                    _container.ExtensionElements.Remove(_items[index]);
                }
            }

            _items[index] = item;
            if (item != null && _container != null)
            {
                _container.ExtensionElements.Add(item);
            }
        }
        ...
        public int Add(T value)
        {
            if (_container != null)
            {
                _container.ExtensionElements.Add(value);
            }
        ...
        {
            if (_container != null && _container.ExtensionElements.Contains(value))
            {
                _container.ExtensionElements.Remove(value);
            }
        ...
        public bool Remove(T value)
        {
            ...
            if (success && _container != null)
            {
                success &= _container.ExtensionElements.Remove(value);
            }
        ...
        protected void OnClear()
        {
            if (_container != null)
            {
                ...
                {
                    _container.ExtensionElements.Remove(_items[i]);
                }
            }
        }
