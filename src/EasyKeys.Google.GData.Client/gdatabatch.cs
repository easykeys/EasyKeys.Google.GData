...
namespace EasyKeys.Google.GData.Client
{
    ...
    public class GDataBatchStatus : IExtensionElementFactory
    {
        ...
        private List<GDataBatchError> _errorList;
        ...
        public List<GDataBatchError> Errors
        {
            get
            {
                if (_errorList == null)
                {
                    _errorList = new List<GDataBatchError>();
                }
        ...
        public void Save(XmlWriter writer)
        {
            ...
            if (Code != GDataBatchStatus.CodeDefault)
            {
                writer.WriteAttributeString(BaseNameTable.XmlAttributeBatchStatusCode, Code.ToString(CultureInfo.InvariantCulture));
            }

            if (Utilities.IsPersistable(ContentType))
            {
                writer.WriteAttributeString(BaseNameTable.XmlAttributeBatchContentType, ContentType);
            }

            if (Utilities.IsPersistable(Reason))
            {
                writer.WriteAttributeString(BaseNameTable.XmlAttributeBatchReason, Reason);
            }
    ...
    {
        private GDataBatchOperationType _operationType;
        ...
        {
            _operationType = GDataBatchOperationType.Default;
        }
        ...
        public void Save(XmlWriter writer)
        {
            ...
            if (Type != GDataBatchOperationType.Default)
            {
                ...
                writer.WriteAttributeString(BaseNameTable.XmlAttributeType, _operationType.ToString());
                writer.WriteEndElement();
            }
        }
    ...
    public class GDataBatchEntryData : IExtensionElementFactory
    {
        private GDataBatchOperationType _operationType;
        private string _id;
        private GDataBatchStatus _status;
        private GDataBatchInterrupt _interrupt;
        ...
        public void Save(XmlWriter writer)
        {
            ...
            if (Id != null)
            {
                writer.WriteElementString(BaseNameTable.XmlElementBatchId, BaseNameTable.gBatchNamespace, _id);
            }
