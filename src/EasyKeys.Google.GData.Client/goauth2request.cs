...
namespace EasyKeys.Google.GData.Client
{
    ...
    public class GOAuth2Request : GDataGAuthRequest
    {
        ...
        private GOAuth2RequestFactory _factory;
        ...
        protected override void EnsureCredentials()
        {
            ...
            if (string.IsNullOrEmpty(_factory.Parameters.AccessToken))
            {
            ...
            Request.Headers.Add("Authorization", String.Format(
                "{0} {1}", _factory.Parameters.TokenType, _factory.Parameters.AccessToken));
        }
