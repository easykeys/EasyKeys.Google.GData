...
namespace EasyKeys.Google.GData.Client
{
    ...
    public class GDataLoggingRequestFactory : GDataGAuthRequestFactory
    {
        ...
        {
            get { return _strCombined; }
            set { _strCombined = value; }
        }
        /////////////////////////////////////////////////////////////////////////////
        ...
        {
            _strInput = "GDatarequest.xml";
            _strOutput = "GDataresponse.xml";
            _strCombined = "GDatatraffic.log";
        }
        /////////////////////////////////////////////////////////////////////////////
        ...
        {
            return new GDataLoggingRequest(type, uriTarget, this, _strInput, _strOutput, _strCombined);
        }
        /////////////////////////////////////////////////////////////////////////////
    }
    /////////////////////////////////////////////////////////////////////////////
    ...
    public class GDataLoggingRequest : GDataGAuthRequest, IDisposable
    {
        ...
        public override void Execute()
        {
            ...
            catch (GDataRequestException re)
            {
                ...
                StreamWriter w = new StreamWriter(_strOutput);
                StreamWriter x = new StreamWriter(_strCombined, true, System.Text.Encoding.UTF8, 512);
        ...
        {
            // save the response to the log
            StreamWriter w = new StreamWriter(_strInput);
            StreamWriter x = new StreamWriter(_strCombined, true, System.Text.Encoding.UTF8, 512);
            ...
            if (RequestCopy != null)
            {
                RequestCopy.Seek(0, SeekOrigin.Begin);
                SaveStream(RequestCopy, w, x);
                RequestCopy.Seek(0, SeekOrigin.Begin);
            }
        ...
        public override Stream GetResponseStream()
        {
            if (_memoryStream == null)
            {
                ...
                if (req != null)
                {
                    ...
                    {
                        _memoryStream.Write(bytes, 0, numBytes);
                    }
