...
namespace EasyKeys.Google.GData.Client
{
    ...
    public partial class Service : IService, IVersionAware
    {
        ...
        private IGDataRequestFactory _factory;
        ...
        public Service(string applicationName)
            : base()
        {
            RequestFactory = new GDataRequestFactory(applicationName == null ?
                GetType().Name : applicationName);
            InitVersionInformation();
        }
        ...
        {
            get { return _factory; }
            set { _factory = value; OnRequestFactoryChanged(); }
        }
        ...
        {
            long l;
            return Query(queryUri, ifModifiedSince, null, out l);
        }
        ...
        {
            long l;
            return Query(queryUri, DateTime.MinValue, etag, out l);
        }
        ...
        private Stream Query(Uri queryUri, DateTime ifModifiedSince, string etag, out long contentLength)
        {
            ...
            IGDataRequest request = RequestFactory.CreateRequest(GDataRequestType.Query, queryUri);
        ...
        public Stream QueryOpenSearchRssDescription(Uri serviceUri)
        {
            ...
            IGDataRequest request = RequestFactory.CreateRequest(GDataRequestType.Query, serviceUri);
            request.Credentials = Credentials;
            request.Execute();
            // return the response
        ...
        {
            return Update(entry, null) as TEntry;
        }
        ...
        {
            return Insert(feedUri, entry, null) as TEntry;
        }
        ...
        {
            return Insert(new Uri(feedUri), entry, null) as TEntry;
        }
        ...
        internal virtual Stream EntrySend(Uri feedUri, AtomBase baseEntry, GDataRequestType type, AsyncSendData data)
        {
            ...
            _versionInfo.ImprintVersion(baseEntry);

            IGDataRequest request = RequestFactory.CreateRequest(type, feedUri);
            request.Credentials = Credentials;
        ...
        public Stream StringSend(Uri targetUri, String payload, GDataRequestType type)
        {
            ...
            IGDataRequest request = RequestFactory.CreateRequest(type, targetUri);
            request.Credentials = Credentials;
    ...
    public class GDataReturnStream : Stream, ISupportsEtag
    {
        ...
        {
            _innerStream = r.GetResponseStream();
