...
namespace EasyKeys.Google.GData.Extensions
{
    ...
    public abstract class SimpleElement : ExtensionBase
    {
        ...
        {
            get { return Convert.ToUInt64(Value, CultureInfo.InvariantCulture); }
            set { Value = value.ToString(CultureInfo.InvariantCulture); }
        }
        ...
        {
            get { return Utilities.XSDTrue == Value; }
            set { Value = value ? Utilities.XSDTrue : Utilities.XSDFalse; }
        }
        ...
        public override IExtensionElementFactory CreateInstance(XmlNode node, AtomFeedParser parser)
        {
            ...
            e = MemberwiseClone() as SimpleElement;
            e.InitInstance(this);
    ...
    public abstract class SimpleAttribute : SimpleElement
    {
        ...
        protected SimpleAttribute(string name, string prefix, string ns)
            : base(name, prefix, ns)
        {
            Attributes.Add(BaseNameTable.XmlValue, null);
        }
        ...
        protected SimpleAttribute(string name, string prefix, string ns, string value)
            : base(name, prefix, ns)
        {
            Attributes.Add(BaseNameTable.XmlValue, value);
        }
        ...
        public override string Value
        {
            get
            {
                return Attributes[BaseNameTable.XmlValue] as string;
            }

            set
            {
                Attributes[BaseNameTable.XmlValue] = value;
            }
        }
    }
    ...
    public abstract class SimpleNameValueAttribute : SimpleAttribute
    {
        ...
        {
            Attributes.Add(BaseNameTable.XmlName, null);
        }
        ...
        public string Name
        {
            get
            {
                return Attributes[BaseNameTable.XmlName] as string;
            }

            set
            {
                Attributes[BaseNameTable.XmlName] = value;
            }
        }
    }
}
