...
namespace EasyKeys.Google.GData.ContentForShopping
{
    ...
    public class ContentForShoppingService : Service
    {
        ...
        private string _projection = "schema";
        ...
        public ProductFeed Query(ProductQuery feedQuery)
        {
            ...
            {
                feedQuery.AccountId = AccountId;
            }

            if (feedQuery.Projection == null)
            {
                feedQuery.Projection = Projection;
            }
        ...
        {
            return UpdateInventoryFeed(entries, _accountId);
        }
        ...
        {
            return CreateUri(AccountId, resource, Projection, path);
        }
