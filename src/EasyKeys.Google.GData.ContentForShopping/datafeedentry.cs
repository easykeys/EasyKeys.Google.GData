...
namespace EasyKeys.Google.GData.ContentForShopping
{
    ...
    public class DatafeedEntry : AbstractEntry
    {
        public DatafeedEntry()
            : base()
        {
            AddExtension(new AttributeLanguage());
            AddExtension(new ContentLanguage());
            AddExtension(new FeedFileName());
            AddExtension(new FeedType());
            AddExtension(new FileFormat());
            AddExtension(new TargetCountry());
            AddExtension(new ProcessingStatus());
        }
        ...
        public string AttributeLanguage
        {
            get
            {
                return GetStringValue<AttributeLanguage>(
            ...
            set
            {
                SetStringValue<AttributeLanguage>(
                    value,
                    ContentForShoppingNameTable.AttributeLanguage,
                    ContentForShoppingNameTable.BaseNamespace);
            }
        ...
        public string FeedFileName
        {
            get
            {
                return GetStringValue<FeedFileName>(
        ...
        public string FeedType
        {
            get
            {
                return GetStringValue<FeedType>(
        ...
        public ProcessingStatus ProcessingStatus
        {
            ...
            {
                return FindExtension(
                    ContentForShoppingNameTable.ProcessingStatus,
