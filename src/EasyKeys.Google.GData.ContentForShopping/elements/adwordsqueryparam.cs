...
{
    public class AdwordsQueryParam : SimpleElement
    {
        /// <summary>
        /// default constructor for scp:adwords_queryparam
        /// </summary>
        public AdwordsQueryParam()
            : base(
                ContentForShoppingNameTable.AdwordsQueryParam,
