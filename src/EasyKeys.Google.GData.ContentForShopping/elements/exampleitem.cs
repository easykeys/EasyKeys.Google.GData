...
namespace EasyKeys.Google.GData.ContentForShopping.Elements
{
    public class ExampleItem : SimpleContainer
    {
        ...
        public string ExampleItemLink
        {
            get
            {
                return GetStringValue<ExampleItemLink>(
            ...
            set
            {
                SetStringValue<ExampleItemLink>(
                    value.ToString(),
                    AtomParserNameTable.XmlLinkElement,
                    ContentForShoppingNameTable.BaseNamespace);
            }
        ...
        public string ExampleItemTitle
        {
            get
            {
                return GetStringValue<ExampleItemTitle>(
                    AtomParserNameTable.XmlLinkElement,
                    ContentForShoppingNameTable.BaseNamespace);
            }
            ...
            set
            {
                SetStringValue<ExampleItemTitle>(
                    value.ToString(),
                    AtomParserNameTable.XmlLinkElement,
                    ContentForShoppingNameTable.BaseNamespace);
            }
        ...
        public string SubmittedValue
        {
            get
            {
                return GetStringValue<SubmittedValue>(
        ...
        public string ValueOnLandingPage
        {
            get
            {
                return GetStringValue<ValueOnLandingPage>(
            ...
            set
            {
                SetStringValue<ValueOnLandingPage>(
                    value.ToString(),
                    ContentForShoppingNameTable.ValueOnLandingPage,
                    ContentForShoppingNameTable.BaseNamespace);
            }
