...
{
    public class ExcludedDestination : SimpleElement
    {
        /// <summary>
        ...
        public ExcludedDestination()
            : base(
                ContentForShoppingNameTable.ExcludedDestination,
        ...
        /// <summary>
        /// Constructs a new ExcludedDestination instance with the specified values.
        /// </summary>
        /// <param name="destination">The required destination.</param>
        public ExcludedDestination(string destination)
            : base(
                ContentForShoppingNameTable.ExcludedDestination,
            ContentForShoppingNameTable.scDataPrefix,
            ContentForShoppingNameTable.BaseNamespace)
