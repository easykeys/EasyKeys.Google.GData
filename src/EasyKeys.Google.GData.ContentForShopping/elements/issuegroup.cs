...
namespace EasyKeys.Google.GData.ContentForShopping.Elements
{
    public class IssueGroup : SimpleContainer
    {
        ...
        /// Issue collection
        /// </summary>
        private ExtensionCollection<Issue> _issues;
        ...
        public ExtensionCollection<Issue> Issues
        {
            get
            {
                if (_issues == null)
                {
                    _issues = new ExtensionCollection<Issue>(this);
                }
