...
namespace EasyKeys.Google.GData.ContentForShopping.Elements
{
    public class Shipping : SimpleContainer
    {
        ...
        public string Country
        {
            get
            {
                return GetStringValue<ShippingCountry>(
            ...
            set
            {
                SetStringValue<ShippingCountry>(
                    value.ToString(),
                    ContentForShoppingNameTable.ShippingCountry,
                    ContentForShoppingNameTable.ProductsNamespace);
            }
        ...
        public string Region
        {
            get
            {
                return GetStringValue<ShippingRegion>(
        ...
        public string Service
        {
            get
            {
                return GetStringValue<ShippingService>(
            ...
            set
            {
                SetStringValue<ShippingService>(
                    value.ToString(),
                    ContentForShoppingNameTable.ShippingService,
                    ContentForShoppingNameTable.ProductsNamespace);
            }
        ...
        public ShippingPrice Price
        {
            get
            {
                return FindExtension(
                    ContentForShoppingNameTable.ShippingPrice,
