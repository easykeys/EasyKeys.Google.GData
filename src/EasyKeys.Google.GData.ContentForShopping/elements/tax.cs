...
namespace EasyKeys.Google.GData.ContentForShopping.Elements
{
    public class Tax : SimpleContainer
    {
        ...
        public string Country
        {
            get
            {
                return GetStringValue<TaxCountry>(
        ...
        public string Region
        {
            get
            {
                return GetStringValue<TaxRegion>(
