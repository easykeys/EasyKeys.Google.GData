...
{
    public class UnitPricingBaseMeasure : SimpleElement
    {
        /// <summary>
        /// default constructor for scp:unit_pricing_base_measure
        /// </summary>
        ...
        /// <summary>
        /// Constructs a new UnitPricingBaseMeasure instance with the specified values.
        /// </summary>
        /// <param name="unit">The unit pricing base measure unit.</param>
        /// <param name="value">The unit pricing base measure's value.</param>
        public UnitPricingBaseMeasure(string unit, string val)
            : base(
                ContentForShoppingNameTable.UnitPricingBaseMeasure,
               ContentForShoppingNameTable.scpDataPrefix,
               ContentForShoppingNameTable.ProductsNamespace)
