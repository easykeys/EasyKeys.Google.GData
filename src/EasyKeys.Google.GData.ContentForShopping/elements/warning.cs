...
namespace EasyKeys.Google.GData.ContentForShopping.Elements
{
    public class Warning : SimpleContainer
    {
        ...
        public string Code
        {
            get
            {
                return GetStringValue<WarningCode>(
        ...
        public string Domain
        {
            get
            {
                return GetStringValue<WarningDomain>(
        ...
        public string Location
        {
            get
            {
                return GetStringValue<WarningLocation>(
            ...
            set
            {
                SetStringValue<WarningLocation>(
                    value.ToString(),
                    ContentForShoppingNameTable.WarningLocation,
                    ContentForShoppingNameTable.BaseNamespace);
            }
        ...
        public string Message
        {
            get
            {
                return GetStringValue<WarningMessage>(
