...
namespace EasyKeys.Google.GData.ContentForShopping
{
    ...
    public class ManagedAccountsEntry : AbstractEntry
    {
        public ManagedAccountsEntry()
            : base()
        {
            AddExtension(new AdultContent());
            AddExtension(new InternalId());
            AddExtension(new ReviewsUrl());
            AddExtension(new AccountStatus());
            AddExtension(new AdwordsAccounts());
        }
        ...
        public string AdultContent
        {
            get
            {
                return GetStringValue<AdultContent>(
        ...
        public string InternalId
        {
            get
            {
                return GetStringValue<InternalId>(
        ...
        public string ReviewsUrl
        {
            get
            {
                return GetStringValue<ReviewsUrl>(
        ...
        public string AccountStatus
        {
            get
            {
                return GetStringValue<AccountStatus>(
