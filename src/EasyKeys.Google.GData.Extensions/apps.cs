...
namespace EasyKeys.Google.GData.Extensions.Apps
{
    /// <summary>
    ...
    public class LabelElement : ExtensionBase
    {
        ...
        public LabelElement()
            : base(
                AppsMigrationNameTable.AppsLabel,
        ...
        {
            get { return Convert.ToString(Attributes[AppsMigrationNameTable.AppsLabelName]); }
            set { Attributes[AppsMigrationNameTable.AppsLabelName] = value; }
        }
    }
    ...
    public class Rfc822MsgElement : ExtensionBase
    {
        ...
        public Rfc822MsgElement(byte[] value, EncodingMethod messageEncoding)
            : base(
                AppsMigrationNameTable.AppsRfc822Msg,
                   AppsMigrationNameTable.AppsPrefix,
                   AppsMigrationNameTable.AppsNamespace)
        {
            Value = value;
        ...
        public EncodingMethod MessageEncoding
        {
            get
            {
                return (EncodingMethod)Enum.Parse(
                    typeof(EncodingMethod),
        ...
        {
            return Encoding.ASCII.GetString(_value, 0, _value.Length);
        }
        ...
        public override IExtensionElementFactory CreateInstance(XmlNode node, AtomFeedParser parser)
        {
            ...
            e = MemberwiseClone() as Rfc822MsgElement;
            e.InitInstance(this);
        ...
        public override void SaveInnerXml(XmlWriter writer)
        {
            if (_value != null)
            {
                ...
                while (curPos < end)
                {
                    ...
                    string str = System.Text.Encoding.ASCII.GetString(_value, curPos, copyLen);
    ...
    public class MailItemPropertyElement : ExtensionBase
    {
        ...
        public MailItemProperty Value
        {
            get
            {
                return (MailItemProperty)Enum.Parse(
                    typeof(MailItemProperty),
    ...
    public class PropertyElement : ExtensionBase
    {
        ...
        public PropertyElement()
            : base(
                AppsNameTable.AppsPropery,
                   AppsNameTable.AppsPrefix,
                   AppsNameTable.AppsNamespace)
        {
            Attributes.Add(AppsNameTable.AppsProperyName, null);
            Attributes.Add(AppsNameTable.AppsProperyValue, null);
        }
        ...
        public PropertyElement(string name, string value)
            : base(
                AppsNameTable.AppsPropery,
                   ...
                   AppsNameTable.AppsNamespace)
        {
            Attributes.Add(AppsNameTable.AppsProperyName, name);
            Attributes.Add(AppsNameTable.AppsProperyValue, value);
        }

        public string Name
        {
            get { return Attributes[AppsNameTable.AppsProperyName] as string; }
            set { Attributes[AppsNameTable.AppsProperyName] = value; }
        }
        ...
        public string Value
        {
            get { return Attributes[AppsNameTable.AppsProperyValue] as string; }
            set { Attributes[AppsNameTable.AppsProperyValue] = value; }
        }
        ...
        public override void Save(XmlWriter writer)
        {
            ...
            if (Attributes != null)
            {
                ...
                {
                    if (Attributes.GetByIndex(i) != null)
                    {
                        string name = Attributes.GetKey(i) as string;
                        string value = Utilities.ConvertToXSDString(Attributes.GetByIndex(i));
