...
namespace EasyKeys.Google.GData.Extensions.Exif
{
    /// <summary>
    ...
    public class ExifTags : SimpleContainer
    {
        ...
        public ExifImageUniqueID ImageUniqueID
        {
            ...
            {
                return FindExtension(
                    ExifNameTable.ExifImageUniqueID,
