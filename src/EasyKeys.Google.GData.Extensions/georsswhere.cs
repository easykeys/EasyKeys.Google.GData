...
namespace EasyKeys.Google.GData.Extensions.Location
{
    /// <summary>
    ...
    public class GeoRssWhere : SimpleContainer
    {
        ...
        public GeoRssWhere(double latitude, double longitude) : this()
        {
            Latitude = latitude;
            Longitude = longitude;
        }
    ...
    public class GeoKmlPosition : SimpleElement
    {
        ...
        public GeoKmlPosition(string initValue) : base(
            GeoNametable.GeoKmlPositionElement,
                 GeoNametable.geoKmlPrefix,
        ...
        public double Latitude
        {
            ...
            {
                string[] values = Value.Split(new char[] { ' ' });
                Value = value.ToString(CultureInfo.InvariantCulture) + " " + values[1];
            }
        }
        ...
        public double Longitude
        {
            ...
            {
                string[] values = Value.Split(new char[] { ' ' });
                Value = values[0] + " " + value.ToString(CultureInfo.InvariantCulture);
            }
        }
    }
}
