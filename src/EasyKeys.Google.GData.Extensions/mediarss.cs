...
namespace EasyKeys.Google.GData.Extensions.MediaRss
{
    /// <summary>
    ...
    {
        private ExtensionCollection<MediaThumbnail> _thumbnails;
        private ExtensionCollection<MediaContent> _contents;
        private ExtensionCollection<MediaCategory> _categories;
        ...
        public MediaCredit Credit
        {
            get
            {
                return FindExtension(
                    MediaRssNameTable.MediaRssCredit,
        ...
        public MediaRestriction Restriction
        {
            ...
            {
                return FindExtension(
                    MediaRssNameTable.MediaRssRestriction,
        ...
        public MediaContent Content
        {
            ...
            {
                return FindExtension(
                    MediaRssNameTable.MediaRssContent,
        ...
        public MediaDescription Description
        {
            ...
            {
                return FindExtension(
                    MediaRssNameTable.MediaRssDescription,
        ...
        public MediaKeywords Keywords
        {
            ...
            {
                return FindExtension(
                    MediaRssNameTable.MediaRssKeywords,
        ...
        public MediaTitle Title
        {
            ...
            {
                return FindExtension(
                    MediaRssNameTable.MediaRssTitle,
        ...
        public MediaRating Rating
        {
            ...
            {
                return FindExtension(
                    MediaRssNameTable.MediaRssRating,
        ...
        public ExtensionCollection<MediaThumbnail> Thumbnails
        {
            get
            {
                if (_thumbnails == null)
                {
                    _thumbnails = new ExtensionCollection<MediaThumbnail>(this);
                }
        ...
        public ExtensionCollection<MediaContent> Contents
        {
            get
            {
                if (_contents == null)
                {
                    _contents = new ExtensionCollection<MediaContent>(this);
                }
        ...
        public ExtensionCollection<MediaCategory> Categories
        {
            get
            {
                if (_categories == null)
                {
                    _categories = new ExtensionCollection<MediaCategory>(this);
                }
        ...
        public MediaPlayer Player
        {
            ...
            {
                return FindExtension(
                    MediaRssNameTable.MediaRssPlayer,
    ...
    public class MediaCredit : SimpleElement
    {
        ...
        : base(
            MediaRssNameTable.MediaRssCredit,
               ...
               MediaRssNameTable.NSMediaRss)
        {
            Attributes.Add("role", null);
            Attributes.Add("scheme", null);
        }
        ...
        public string Scheme
        {
            get
            {
                return Attributes["scheme"] as string;
            }
        ...
        public string Role
        {
            get
            {
                return Attributes["role"] as string;
            }
    ...
    public class MediaRestriction : SimpleElement
    {
        ...
        : base(
            MediaRssNameTable.MediaRssRestriction,
               ...
               MediaRssNameTable.NSMediaRss)
        {
            Attributes.Add(AttributeType, null);
            Attributes.Add(AttributeRel, null);
        }
        ...
        public string Relationship
        {
            get
            {
                return Attributes[AttributeRel] as string;
            }

            set
            {
                Attributes[AttributeRel] = value;
            }
        }
    }
    ...
    public class MediaPlayer : SimpleElement
    {
        ...
        : base(
            MediaRssNameTable.MediaRssPlayer,
               ...
               MediaRssNameTable.NSMediaRss)
        {
            Attributes.Add(MediaRssNameTable.AttributeUrl, null);
        }
        ...
        public string Url
        {
            get
            {
                return Attributes[MediaRssNameTable.AttributeUrl] as string;
            }

            set
            {
                Attributes[MediaRssNameTable.AttributeUrl] = value;
            }
        }
    ...
    public class MediaContent : SimpleElement
    {
        ...
        {
            Attributes.Add(MediaRssNameTable.AttributeUrl, null);
            Attributes.Add(MediaRssNameTable.AttributeType, null);
            Attributes.Add(MediaRssNameTable.AttributeDefault, null);
            Attributes.Add(MediaRssNameTable.AttributeExpression, null);
            Attributes.Add(MediaRssNameTable.AttributeDuration, null);
        }
        ...
        public string Height
        {
            get
            {
                return Attributes[MediaRssNameTable.AttributeHeight] as string;
            }

            set
            {
                Attributes[MediaRssNameTable.AttributeHeight] = value;
            }
        }
        ...
        public string Width
        {
            get
            {
                return Attributes[MediaRssNameTable.AttributeWidth] as string;
            }

            set
            {
                Attributes[MediaRssNameTable.AttributeWidth] = value;
            }
        }
        ...
        public string Type
        {
            get
            {
                return Attributes[MediaRssNameTable.AttributeType] as string;
            }

            set
            {
                Attributes[MediaRssNameTable.AttributeType] = value;
            }
        }
        ...
        public string Duration
        {
            get
            {
                return Attributes[MediaRssNameTable.AttributeDuration] as string;
            }

            set
            {
                Attributes[MediaRssNameTable.AttributeDuration] = value;
            }
        }
    }
    ...
    public class MediaCategory : SimpleElement
    {
        ...
        : base(
            MediaRssNameTable.MediaRssCategory,
               MediaRssNameTable.mediaRssPrefix,
               MediaRssNameTable.NSMediaRss)
        {
            Attributes.Add("scheme", null);
            Attributes.Add("label", null);
        }
    ...
    public class MediaThumbnail : SimpleElement
    {
        ...
        : base(
            MediaRssNameTable.MediaRssThumbnail,
               MediaRssNameTable.mediaRssPrefix,
               MediaRssNameTable.NSMediaRss)
        {
            Attributes.Add(MediaRssNameTable.AttributeUrl, null);
            Attributes.Add(MediaRssNameTable.AttributeHeight, null);
            Attributes.Add(MediaRssNameTable.AttributeWidth, null);
            Attributes.Add(MediaRssNameTable.AttributeTime, null);
        }
        ...
        public string Time
        {
            get
            {
                return Attributes[MediaRssNameTable.AttributeTime] as string;
            }

            set
            {
                Attributes[MediaRssNameTable.AttributeTime] = value;
            }
        }
    ...
    public class MediaRating : SimpleElement
    {
        ...
        public string Country
        {
            get
            {
                return Attributes["country"] as string;
            }
