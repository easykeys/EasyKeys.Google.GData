...
namespace EasyKeys.Google.GData.Extensions
{
    ...
    public class LastViewed : SimpleElement
    {
        ...
        public LastViewed()
            : base(
                GDataParserNameTable.XmlLastViewedElement,
            GDataParserNameTable.gDataPrefix,
            GDataParserNameTable.gNamespace)
        {
        }
    ...
    public class LastModifiedBy : SimpleContainer
    {
        ...
        public string Name
        {
            get
            {
                return GetStringValue<LastModifiedByName>(
                    GDataParserNameTable.XmlName,
        ...
        public string EMail
        {
            get
            {
                return GetStringValue<LastModifiedByEMail>(
