...
namespace EasyKeys.Google.GData.Extensions
{
    ...
    public class OriginalEvent : SimpleContainer
    {
        ...
        public string Href
        {
            get { return Attributes[GDataParserNameTable.XmlAttributeHref] as string; }
            set { Attributes[GDataParserNameTable.XmlAttributeHref] = value; }
        }
        ...
        {
            get { return Attributes[GDataParserNameTable.XmlAttributeId] as string; }
            set { Attributes[GDataParserNameTable.XmlAttributeId] = value; }
        }
        ...
        public When OriginalStartTime
        {
            get
            {
                return FindExtension(
                    GDataParserNameTable.XmlWhenElement,
