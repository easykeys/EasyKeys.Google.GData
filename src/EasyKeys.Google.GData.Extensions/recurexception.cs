...
namespace EasyKeys.Google.GData.Extensions
{
    ...
    public class RecurrenceException : SimpleContainer
    {
        ...
        public bool Specialized
        {
            get
            {
                return bool.Parse(Attributes[GDataParserNameTable.XmlAttributeSpecialized] as string);
            }

            set
            {
                Attributes[GDataParserNameTable.XmlAttributeSpecialized] = value;
            }
        }
        ...
        public EntryLink EntryLink
        {
            get
            {
                return FindExtension(
                    GDataParserNameTable.XmlEntryLinkElement,
